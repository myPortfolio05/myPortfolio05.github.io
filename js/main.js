$(document).ready(function(){
    ...
    $('.language').click(function(){
        ...
        if(lang == 'ru'){
            ...
            +'CSS3 JavaScript ES6, jQuery, Bootstrap4. After graduating the courses I trained my skills, '
            ...
            +'CSS3 JavaScript ES6, jQuery, Bootstrap4. После окончания курсов тренировал навыки, '
            +'выполняя задания на <a id="freecode">freeCodeCamp</a> и сделал несколько проектов различной тематики. '
            +'Цель на данный момент - найти место работы, на котором смогу развивать свои умения, рассширять и углублять '
            ...
            +'ноутбуках, и мобильных устройствах с различными форматом и расширением экрана.</p>');
            ...
            +'Сайт обладает адаптивным дизайном, рассчитанным на различные устройства с разным расширением экрана.</p>');
